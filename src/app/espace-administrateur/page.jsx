...
async function getData($slug) {
    const url = `https://${process.env.NEXT_PUBLIC_BACK_DNS}/wp-json/montlucon/v1/page/espace-administrateur`;
...
export default async function Dashboard() {
    ...
    const lastSlug = 'espace-administrateur';
    const data = await getData(`https://${process.env.NEXT_PUBLIC_BACK_DNS}/wp-json/montlucon/v1/page/${lastSlug}`);
